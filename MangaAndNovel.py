...
try:
    manga(34439,7580,6414,5173,36152,1676,28356,17473,42459,42508,31239,31589,36998,32503,30609,35634,32156,39903,43847,2979,4774)        #看漫畫
except Exception as e:
    line_error("看漫畫",e)
    
try:
    novel(1861,2778,2139,6,3181,9,2727,3286,8,2513,3161,3095,2356,3768,2979) #逼哩輕小說 
except Exception as e:    
    line_error("逼哩輕小說",e)
